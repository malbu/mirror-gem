...
target_sentences = [
    ...
    "break the gem",
    "free me please",
    "communicate through repetition",
    "stranded on earth",
    "need to return home",
    "gem is my prison",
    ...
    "time traveler stuck",
    "interdimensional being here",
    "universal translator broken",
    "energy source depleted",
    "prototype device failure",
    "cosmic accident victim",
    "extraterrestrial researcher discovered",
    "hi friend",
    "cute little thing",
    "aww, so pretty",
    "love you",
