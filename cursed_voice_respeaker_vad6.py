...
target_sentence = "dexter serial blood cop brother morgan"
        ...
        try:
            ...
            for target_word in target_words:
                if target_word in text.lower():
                    if target_word not in detected_words:
                        detected_words.append(target_word)
                        print(f"Detected word: {target_word}")
                        print()
                        word_timestamps.append((target_word, audio_data))
